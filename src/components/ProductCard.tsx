...
function ProductCardComponent({ product, overridePrice, eyeNavigates }: ProductCardProps) {
  ...
  />
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-3">
                  <button className="premium-btn" onClick={addToCart}>
                    Add to Cart
                  </button>
...
// ⬅️ Final enhancement: Memoize component
